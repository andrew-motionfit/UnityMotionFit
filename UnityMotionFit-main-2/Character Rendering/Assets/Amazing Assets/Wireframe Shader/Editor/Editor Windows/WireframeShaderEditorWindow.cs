        ...
        public class WireframeShaderEditorWindow : EditorWindow
        {
            ...
            void LoadResources()
            {
                ...
                if (iconRemoveItem == null)
                    iconRemoveItem = (Texture2D)AssetDatabase.LoadAssetAtPath(Path.Combine(EditorUtilities.GetWireframeShaderEditorFolderPath(), "Editor", "Icons", "delete.png"), typeof(Texture2D));

                if (iconWireframe == null)
                    iconWireframe = (Texture2D)AssetDatabase.LoadAssetAtPath(Path.Combine(EditorUtilities.GetWireframeShaderEditorFolderPath(), "Editor", "Icons", "wireframe.png"), typeof(Texture2D));
                if (iconDistanceFade == null)
                    iconDistanceFade = (Texture2D)AssetDatabase.LoadAssetAtPath(Path.Combine(EditorUtilities.GetWireframeShaderEditorFolderPath(), "Editor", "Icons", "distance.png"), typeof(Texture2D));
                if (iconMaskPlane == null)
                    iconMaskPlane = (Texture2D)AssetDatabase.LoadAssetAtPath(Path.Combine(EditorUtilities.GetWireframeShaderEditorFolderPath(), "Editor", "Icons", "plane.png"), typeof(Texture2D));
                if (iconMaskSphere == null)
                    iconMaskSphere = (Texture2D)AssetDatabase.LoadAssetAtPath(Path.Combine(EditorUtilities.GetWireframeShaderEditorFolderPath(), "Editor", "Icons", "sphere.png"), typeof(Texture2D));
                if (iconMaskBox == null)
                    iconMaskBox = (Texture2D)AssetDatabase.LoadAssetAtPath(Path.Combine(EditorUtilities.GetWireframeShaderEditorFolderPath(), "Editor", "Icons", "box.png"), typeof(Texture2D));


                if (iconDocumentation == null)
                    iconDocumentation = (Texture2D)AssetDatabase.LoadAssetAtPath(Path.Combine(EditorUtilities.GetWireframeShaderEditorFolderPath(), "Editor", "Icons", "manual.png"), typeof(Texture2D));
                if (iconForum == null)
                    iconForum = (Texture2D)AssetDatabase.LoadAssetAtPath(Path.Combine(EditorUtilities.GetWireframeShaderEditorFolderPath(), "Editor", "Icons", "forum.png"), typeof(Texture2D));
                if (iconSupport == null)
                    iconSupport = (Texture2D)AssetDatabase.LoadAssetAtPath(Path.Combine(EditorUtilities.GetWireframeShaderEditorFolderPath(), "Editor", "Icons", "support.png"), typeof(Texture2D));
                if (iconRateAsset == null)
                    iconRateAsset = (Texture2D)AssetDatabase.LoadAssetAtPath(Path.Combine(EditorUtilities.GetWireframeShaderEditorFolderPath(), "Editor", "Icons", "rate.png"), typeof(Texture2D));
